package com.coolweather.android.coolweather.service;
...
public class AutoUpdateService extends Service {
    ...
    private void updateBingPic() {
        ...
        if(weatherString != null) {
            ...
            String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=f08406bbaf0145a18363eb3b67dceaba";
